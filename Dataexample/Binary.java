// // Purpose: To demonstrate the Binary Search Tree data structure
// public class Binary {
...
// 		root = insertHelper(root, node); //call the helper method to insert the node
// 	}
// 	private Node insertHelper(Node root, Node node) { //helper method to insert the node
		
// 		int data = node.data; //get the value of the node
...
// 	int data; //value of the node child node 
// 	Node left; //left child node
// 	Node right;//right child node
	
// 	public Node(int data) { //constructor to create a new node
// 		this.data = data; //initialize the value of the node
// 	}
// }